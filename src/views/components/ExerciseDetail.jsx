...
// Archive imported from 'protocols/body/workout/exercise-db'; main renamed
// that module to exercises.js during the port. Its EXERCISE_DB and
// getVideoUrl exports are verbatim-identical to the archive (same shape,
// same names) — only the import path changes here. See
// .superpowers/sdd/task-9-report.md for the full reconciliation notes.
