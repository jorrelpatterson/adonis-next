...
//
// source: v2-revival-archive:src/views/components/TaskContextMenu.jsx
// Pulled forward from Phase 4 as a Task 14 (RoutineView) dependency — see
// docs/v1-feature-parity-ledger.md dated note and task-14-report.md. Ported
// verbatim: every import path it uses (`../../design/theme`,
// `../../design/components`, `../../design/sound`, `../../design/haptics`)
// already resolves correctly from this file's location on main, so no
