...
export const PROTO_STACKS = [
  ...
  },
  {
    ...
    color: '#8B5CF6',
    items: ['CJC/Ipa Blend', 'Tesamorelin 10mg', 'GHRP-2 10mg', 'KLOW Blend', 'DSIP 10mg'],
    why: 'Multi-pathway GH optimization. CJC/Ipa for nightly GH pulse, Tesamorelin for sustained GHRH, GHRP-2 to bump appetite during a bulk. KLOW handles recovery, DSIP locks in deep sleep for GH release.',
  },
  {
    id: 'prime',
    name: 'PRIME',
  ...
  },
  {
    ...
    color: '#F59E0B',
    items: ['Glow Plus', 'GHK-Cu 50mg', 'Snap-8', 'Melanotan II'],
    why: 'Glow Plus for deep collagen (GHK-Cu + BPC + TB blend). Standalone GHK-Cu adds skin repair on top. Snap-8 smooths wrinkles. Melanotan II for tan + libido lift. Pick MT-I instead if you want gradual tanning without sexual side effects.',
  },
  {
    id: 'restore',
    name: 'RESTORE',
    ...
    color: '#34D399',
    items: ['KLOW Blend', 'BPC-157 10mg', 'TB-500 10mg', 'GKP Blend', 'ARA-290'],
    why: 'KLOW for systemic recovery. BPC-157 targets gut + tendons (site injection); TB-500 for systemic tissue repair. GKP rounds out the recovery side. ARA-290 if there is nerve involvement. Use BPC+TB Blend instead of standalones if you prefer one injection.',
  },
  {
    id: 'balance',
    name: 'BALANCE',
    ...
    color: '#A78BFA',
    items: ['Kisspeptin-10 10mg', 'CJC/Ipa Blend', 'MOTS-C 10mg'],
    why: 'Kisspeptin signals upstream for natural LH and testosterone. CJC/Ipa Blend (CJC-1295 + Ipamorelin) handles overnight GH support. MOTS-C improves metabolic efficiency so the system actually responds to the hormonal lift.',
  },
  {
    id: 'sleep',
    name: 'SLEEP',
  ...
  },
  {
    ...
    name: 'LEAN',
    icon: '\u{1F343}',
    tag: 'GLP-1 weight management — Tirzepatide-led',
    target: 'Clients who prefer Tirz/Sema over Retatrutide',
    monthly: '$150-220/mo',
    monthlyLow: 150, monthlyHigh: 220,
    color: '#22C55E',
    items: ['Tirzepatide 10mg', 'AOD-9604 10mg', 'Lipo-C', 'KLOW Blend'],
    why: 'Tirzepatide as the primary GLP-1 (dual GIP/GLP-1 agonist — best clinical fat-loss data outside Reta). AOD-9604 for fasted fat oxidation. Lipo-C lipotropic support. KLOW for GI protection. NEVER stack GLP-1s — if you switch to Semaglutide, drop Tirz first.',
  },
  {
    id: 'drive',
    name: 'DRIVE',
  ...
  },
  {
    ...
    monthlyLow: 200, monthlyHigh: 300,
    color: '#B45309',
    items: ['MGF', 'PEG MGF', 'GHRP-6 10mg', 'TB-500 10mg', 'CJC/Ipa Blend'],
    why: 'MGF for site-specific muscle repair, PEG MGF for sustained growth signaling. GHRP-6 for the strongest appetite bump — picked over GHRP-2 in this stack since hard gainers need the eat-more nudge. TB-500 carries the recovery side; CJC/Ipa Blend gives a steady GH base.',
  },
];
