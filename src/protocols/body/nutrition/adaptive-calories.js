...
//          1.5 lbs/wk gaining)
//
// source: v2-revival-archive:src/protocols/body/nutrition/adaptive-calories.js
// adapted: archive's ./math imported a 5-arg calcBMR(weight, hFt, hIn, age,
// gender); main's calorie-engine.js calcBMR takes a single heightInches
// param instead of separate hFt/hIn. hFt/hIn are combined below the same
// way calcCalorieTarget does it, and weight/height/age are guarded with
// Number(...) || 0 so undefined profile fields can never NaN-propagate
// into baseTDEE/baseTarget — including on the no-goal early-return path,
// which computes baseTDEE/baseTarget before it knows whether a goal is set.

import { calcBMR, calcTDEE } from './calorie-engine.js';
 ...
 *     cycle,                          — v2 addition: getCycleInfo() result or null
 *   }
 */
