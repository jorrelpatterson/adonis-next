...
export const RSS_SOURCES = [
  ...
  // ---- Tier C: Cultural-moment / personality-driven ----
  // Captures the @mybiostack-style hooks: famous-person + peptides moments.
  // Curator may pick AT MOST 1 of these per week (see CURATOR_PROMPT diversity rule).
  { name: 'Google News — Bryan Johnson peptides', tier: 'C', kind: 'rss',
    url: 'https://news.google.com/rss/search?q=%22Bryan+Johnson%22+peptide&hl=en-US&gl=US&ceid=US:en',
    topic_tags: ['pulse','cultural'] },
  { name: 'Google News — Huberman peptides', tier: 'C', kind: 'rss',
    url: 'https://news.google.com/rss/search?q=%22Huberman%22+peptide&hl=en-US&gl=US&ceid=US:en',
    topic_tags: ['pulse','cultural'] },
  { name: 'Google News — RFK Jr / FDA peptides', tier: 'C', kind: 'rss',
    url: 'https://news.google.com/rss/search?q=%22RFK%22+peptide+OR+%22Kennedy%22+FDA+peptide&hl=en-US&gl=US&ceid=US:en',
    topic_tags: ['pulse','cultural','regulatory'] },
  { name: 'Google News — longevity peptide', tier: 'C', kind: 'rss',
    url: 'https://news.google.com/rss/search?q=longevity+peptide+OR+%22escape+velocity%22+peptide&hl=en-US&gl=US&ceid=US:en',
    topic_tags: ['pulse','cultural','longevity'] },
  { name: 'Google News — biohacker peptide', tier: 'C', kind: 'rss',
    url: 'https://news.google.com/rss/search?q=biohacker+peptide+OR+biohacking+peptide&hl=en-US&gl=US&ceid=US:en',
    topic_tags: ['pulse','cultural','biohacker'] },
];
