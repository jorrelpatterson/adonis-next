      ...
      <div style={{...cs.card, overflowX:'auto'}}>
        <table style={{ width:'100%', borderCollapse:'collapse', minWidth:980 }}>
          <thead><tr style={{ background:'#F7F8FA' }}>
            {[{k:'risk',l:'',w:28},{k:'name',l:'Product',w:200},{k:'size',l:'Size',w:64},{k:'cat',l:'Category',w:96},{k:'vendor',l:'Vendor',w:54},{k:'cost',l:'Cost',w:58},{k:'retail',l:'Retail',w:58},{k:'stock',l:'Stock',w:56},{k:'margin',l:'Margin',w:58},{k:'actions',l:'',w:138}].map(c=>(
