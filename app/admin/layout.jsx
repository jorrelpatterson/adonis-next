      ...
      <aside style={{
        ...
        <div style={{ padding: '0 16px', marginBottom: 28, display: 'flex', alignItems: 'center', gap: 10 }}>
          <button onClick={() => setCollapsed(!collapsed)} style={{
            background: 'none', border: 'none', color: '#6B7A94', cursor: 'pointer', fontSize: 18
          }}>☰</button>
          {!collapsed && (
            <div>
              ...
              <div style={{ fontSize: 9, color: '#6B7A94', letterSpacing: 1 }}>v3.0.0</div>
            </div>
          )}
        </div>
        ...
        {!collapsed && (
          <div style={{ padding: '16px 20px', borderTop: '1px solid rgba(255,255,255,0.06)', display: 'flex', flexDirection: 'column', gap: 8 }}>
            <Link href="/app" style={{ fontSize: 11, color: '#6B7A94', textDecoration: 'none' }}>
              ← Back to App
            </Link>
